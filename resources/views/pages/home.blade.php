    ...
    <div class="my-auto">
        <div id class="bg-white px-8 py-5 pb-16 rounded-xl drop-shadow-md">
          ...
          <form class="ajaxForm2" method="POST">
            ...
            <div class="grid grid-cols-6 gap-3">
              <input type="tel" name="ddd" placeholder="DDD" class="ddd2 col-span-2 mb-2 w-full px-3 py-2 border border-[#D9D9D9] rounded-lg focus:drop-shadow-lg focus:border-[#23A6F0] focus:border-2 focus:outline-none transition duration-500">
              <input type="tel" name="numero" placeholder="Telefone" class="js-phoneMask2 col-span-4 mb-2 w-full px-3 py-2 border border-[#D9D9D9] rounded-lg focus:drop-shadow-lg focus:border-[#23A6F0] focus:border-2 focus:outline-none transition duration-500">
            </div>

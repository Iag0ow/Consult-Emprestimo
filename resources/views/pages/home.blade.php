      ...
      <div id="card-form" class="bg-white px-14 py-10 pb-16 rounded-xl drop-shadow-md min-w-[38rem] max-w-[42rem]">
        ...
        <form id="formulario-simulacao" class="ajaxForm" method="POST">
          ...
          <div class="flex flex-wrap">
            <input required type="text" name="nome" placeholder="Nome" autocomplete="off" class="mb-5 w-full px-5 py-5 border border-[#D9D9D9] rounded-lg focus:drop-shadow-lg focus:border-[#23A6F0] focus:border-2 focus:outline-none transition duration-500">
            <input required type="text" name="cnpj" placeholder="CNPJ" autocomplete="off" class="cnpj mb-5 w-full px-5 py-5 border border-[#D9D9D9] rounded-lg focus:drop-shadow-lg focus:border-[#23A6F0] focus:border-2 focus:outline-none transition duration-500">
            <input required name="faturamento" placeholder="Faturamento" autocomplete="off" class="faturamento mb-5 w-full px-5 py-5 border border-[#D9D9D9] rounded-lg focus:drop-shadow-lg focus:border-[#23A6F0] focus:border-2 focus:outline-none transition duration-500" maxlength="30">
          </div>

          <div class="grid grid-cols-6 gap-3">
            <input required type="tel" name="ddd" placeholder="DDD" autocomplete="off" class="ddd col-span-1 mb-5 w-full px-5 py-5 border border-[#D9D9D9] rounded-lg focus:drop-shadow-lg focus:border-[#23A6F0] focus:border-2 focus:outline-none transition duration-500">
            <input required type="tel" name="numero" placeholder="Telefone" autocomplete="off" class="js-phoneMask col-span-5 mb-5 w-full px-5 py-5 border border-[#D9D9D9] rounded-lg focus:drop-shadow-lg focus:border-[#23A6F0] focus:border-2 focus:outline-none transition duration-500">
          </div>
